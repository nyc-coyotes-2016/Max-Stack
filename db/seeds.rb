...
world_domination = Answer.create(text: 'I have taken all the puppies and held them captive in my puppy lab, and I am trying to extract maximum cuteness with their cuteness! Stretch: achieve world domination through puppy cuteness, all the puppy cuteness that could every be accumulated!', question: droopy, responder: zak)

something = Comment.create(content: 'Dolore illum animi et neque accusantium.', commentable: correct, commenter_id: 2)
Comment.create(content: 'Aut voluptatem illum fugit ut sit.', commentable: too_many, commenter_id: 1)
Comment.create(content: 'Cedo vero adipisci. Theatrum crustulum coaegresco tonsor crastinus stabilis. Aliqua crur consequatur amor una tolero sum.', commentable: google, commenter_id: 1)
droopier = Comment.create(content: "Here is a puppy 🐶 🐼", commentable: droopy, commenter_id: 1)
Comment.create(content: 'Inflammatio denego necessitatibus caelestis autus illum.', commentable: math, commenter_id: 2)
Comment.create(content: 'Neque aut et nemo aut incidunt voluptates. Dolore cum est sint est. Vitae assumenda porro odio dolores fugiat. Est voluptatum quia rerum.', commentable: code, commenter_id: 1)
Comment.create(content: 'What are you talking about?', commentable: code, commenter_id: 1)
Comment.create(content: 'Cedo vero adipisci. Theatrum crustulum coaegresco tonsor crastinus stabilis. Aliqua crur consequatur amor una tolero sum.', commentable: partial, commenter_id: 1)
world = Comment.create(content: 'Cool man, totally cool! 🐶', commentable: world_domination, commenter_id: 3)

Vote.create(vote_value: 1, voteable: google, voter_id: 1)
Vote.create(vote_value: 1, voteable: math, voter_id: 2)
Vote.create(vote_value: 1, voteable: world_domination, voter_id: 3)
Vote.create(vote_value: 1, voteable: droopy, voter_id: 4)
Vote.create(vote_value: 1, voteable: too_many, voter_id: 3)

Vote.create(vote_value: -1, voteable: droopier, voter_id: 3)
Vote.create(vote_value: -1, voteable: world, voter_id: 2)
Vote.create(vote_value: -1, voteable: something, voter_id: 1)
Vote.create(vote_value: -1, voteable: google, voter_id: 4)
Vote.create(vote_value: -1, voteable: google, voter_id: 5)
